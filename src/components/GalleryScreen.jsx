...
function GalleryScreen({ generatedImages, setShowGeneratMoreModal, openFullscreen, toggleFavorite, isGenerating, batchSize }) {
    const [images, setImages] = useState([]);

    // Sync local state with incoming generatedImages
    useEffect(() => {
    ...
    return (
        <div className="p-4 space-y-4 h-full">
            <div className="flex items-center justify-between">
                ...
                <button
                    onClick={() => setShowGeneratMoreModal(true)}
